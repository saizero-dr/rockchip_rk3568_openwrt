...
3. Web admin panel default IP is 172.16.0.1 and default password is "photonicat".
...
3. Run `git clone https://github.com/photonicat/rockchip_rk3568_openwrt.git` to clone the source code, and then `cd rockchip_rk3568_openwrt` to enter the directory
...
4. This project bases on Lean's LEDE [here](https://github.com/coolsnowwolf/lede).
